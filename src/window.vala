...
public class BookwormApp.AppWindow {
    ...
    public static Gtk.Box createBoookwormUI () {
        ...
        webkitSettings.set_allow_top_navigation_to_data_urls (false);
        webkitSettings.set_allow_modal_dialogs (false);
        webkitSettings.set_enable_fullscreen (false);
        webkitSettings.set_enable_html5_database (false);
        webkitSettings.set_enable_html5_local_storage (false);
        webkitSettings.set_enable_hyperlink_auditing (false);
        webkitSettings.set_enable_offline_web_application_cache (false);
        webkitSettings.set_enable_java (false);
        webkitSettings.set_enable_plugins (false);
