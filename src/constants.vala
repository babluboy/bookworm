...
namespace BookwormApp.Constants {
	...
	public const string TEXT_FOR_ANNOTATION = _("Edit annotation for:");
	...
	public const string SELECT_BOOK_ICON_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-object-select-symbolic.svg";
	public const string ADD_BOOK_ICON_IMAGE_LOCATION = RESOURCE_PREFIX+"/16-bookworm-list-add.svg";
	public const string REMOVE_BOOK_ICON_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-list-remove.svg";
	public const string LIBRARY_VIEW_GRID_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-view-grid-symbolic.svg";
	public const string LIBRARY_VIEW_LIST_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-view-list-symbolic.svg";
	public const string MORE_LINE_HEIGHT_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-line-height-more.png";
	public const string LESS_LINE_HEIGHT_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-line-height-less.png";
	public const string MORE_LINE_WIDTH_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-width-more.png";
	public const string LESS_LINE_WIDTH_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-width-less.png";
	public const string RATING_NONE_IMAGE_ICON_LOCATION = RESOURCE_PREFIX+"16-bookworm-help-about-symbolic.svg";
	public const string RATING_SELECTED_IMAGE_ICON_LOCATION = RESOURCE_PREFIX+"16-bookworm-help-about.svg";
	public const string TEXT_LARGER_IMAGE_ICON_LOCATION = RESOURCE_PREFIX+"16-bookworm-format-text-larger-symbolic.svg";
	public const string TEXT_SMALLER_IMAGE_ICON_LOCATION = RESOURCE_PREFIX+"16-bookworm-format-text-smaller-symbolic.svg";
	public const string TEXT_ALIGN_LEFT_ICON_LOCATION = RESOURCE_PREFIX+"16-bookworm-format-justify-left.svg";
	public const string TEXT_ALIGN_RIGHT_ICON_LOCATION = RESOURCE_PREFIX+"16-bookworm-format-justify-right.svg";
	public const string RATING_1_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm_rating_1.png";
	public const string RATING_2_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm_rating_2.png";
	public const string RATING_3_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm_rating_3.png";
	public const string RATING_4_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm_rating_4.png";
	public const string RATING_5_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm_rating_5.png";
	public const string UPDATE_IMAGE_ICON_LOCATION = RESOURCE_PREFIX+"16-bookworm-insert-image.svg";
	public const string SELECTION_OPTION_IMAGE_SMALL_LOCATION = RESOURCE_PREFIX+"16-bookworm-selection-option.svg";
	public const string SELECTION_CHECKED_IMAGE_SMALL_LOCATION = RESOURCE_PREFIX+"16-bookworm-selection-checked.svg";
	public const string BOOK_INFO_IMAGE_LOCATION = RESOURCE_PREFIX+"16-bookworm-help-info-symbolic.svg";
	public const string BOOKMARK_INACTIVE_IMAGE_LOCATION = RESOURCE_PREFIX+"24-bookworm-bookmark-inactive.png";
	public const string BOOKMARK_ACTIVE_IMAGE_LOCATION = RESOURCE_PREFIX+"24-bookworm-bookmark-active.png";
	public const string SELECTION_OPTION_IMAGE_LOCATION = RESOURCE_PREFIX+"24-bookworm-selection-option.svg";
	public const string SELECTION_CHECKED_IMAGE_LOCATION = RESOURCE_PREFIX+"24-bookworm-selection-checked.svg";
	public const string HEADERBAR_PROPERTIES_IMAGE_LOCATION = RESOURCE_PREFIX+"24-bookworm-open-menu.svg";
	public const string DEFAULT_COVER_IMAGE_LOCATION = RESOURCE_PREFIX+"bookworm-default-cover-N.svg";
	public const string PLACEHOLDER_COVER_IMAGE_LOCATION = RESOURCE_PREFIX+"bookworm-placeholder-cover.svg";
	...
	public const string DYNAMIC_CSS_CONTENT = " button.PROFILE_BUTTON_1 { color: <profile_1_color>; background-color: <profile_1_bgcolor>; border-color: #B0C4DE; } button.PROFILE_BUTTON_2 { color: <profile_2_color>; background-color: <profile_2_bgcolor>; border-color: #B0C4DE; } button.PROFILE_BUTTON_3 { color: <profile_3_color>; background-color: <profile_3_bgcolor>; border-color: #B0C4DE; }  GtkButton.PROFILE_BUTTON_1 { color: <profile_1_color>; background-color:  <profile_1_bgcolor>; border-color: #B0C4DE; } GtkButton.PROFILE_BUTTON_2 { color: <profile_2_color>; background-color: <profile_2_bgcolor>; border-color: #B0C4DE; } GtkButton.PROFILE_BUTTON_3 { color: <profile_3_color>; background-color: <profile_3_bgcolor>; border-color: #151B1C; }";
}
